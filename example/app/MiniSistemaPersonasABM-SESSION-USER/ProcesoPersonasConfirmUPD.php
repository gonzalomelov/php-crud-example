<?php
    ...
    // OBTENER DATOS DEL REGISTRO DEL ID DE PERSONA A MODIFICAR
...
<head>
	...
	<title>MiniSistema ABM de Personas con MySQL - ACTUALIZAR</title>
...
<!-- SECCION CABECERA -->
    <div id="head">
      ...
      <span>Sesiones de Usuarios -</span><span style="color: orange;">ACTUALIZAR</span>
    </div>
<!-- SECCION MENU -->
<?php include "menu.inc"; ?>
<!-- SECCION CONTENIDO -->
    <div id="contenido">
        <form id="frmUPD" action="ProcesoPersonasUPD.php" method="POST">
          <fieldset id="form">
           <legend id="titform">Actualizar Datos</legend>
            <table id="form">
              <tr>
                <td colspan="2">&nbsp;</td>
              </tr>
              ...
              <tr>
                ...
                <td>
                  <select name="DTO" 
                          id="dataDTO" 
                  >
                    <option value="0">- Seleccionar Dtpo. -</option>
                    <?php
              ...
              <tr>
                <td colspan="2">
                    <input type="button" value="Enviar" onclick="CheckID('frmUPD');"/>
