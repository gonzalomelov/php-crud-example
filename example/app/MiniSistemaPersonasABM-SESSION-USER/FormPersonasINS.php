...
<head>
	...
	<title>MiniSistema ABM de Personas con MySQL - INSERTAR</title>
...
<!-- SECCION CABECERA -->
    <div id="head">
      ...
      <span>Sesiones de Usuarios -</span><span style="color: orange;">INSERTAR</span>
    </div>
<!-- SECCION MENU -->
<?php include "menu.inc"; ?>
<!-- SECCION CONTENIDO -->
    <div id="contenido">
        <form id="frm" action="ProcesoPersonasINS.php" method="POST">
          <fieldset id="form">
           <legend id="titform">Ingreso de Datos</legend>
            <table id="form">
              ...
              <tr>
                <td>Departamento</td>
                <td>
                  <select name="DTO" id="dataDTO" title="Seleccionar Departamento">
